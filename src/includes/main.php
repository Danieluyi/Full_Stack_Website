      ...
      <div class="container clearfix">
        ...
        <div class="currency">
          ...
          <?php
			...
			// This identifies the visitor by account name using $_SESSION
			// However that works
...
// Also Uses $_SESSION to determine whether to show the 
// user a login link or my account link
if(!isset($_SESSION['customer_email'])){
...
// Also Uses $_SESSION to determine whether to show the 
// user a signin link or signout link
if(!isset($_SESSION['customer_email'])){
      ...
      <div class="container clearfix">
        ...
        <div class="logo">
          <a class="logo__link" href="index.php">
            <img class="logo__img" src="images/logo.png" alt="Khrov Web Store" width="237" height="19">
          </a>
        </div>
