<?php
	// This is for the left sidebar in shop.php
	// This sidebar tries to use ajax to auto-filter
	// the products displayed in body and change pagination
	// numbering at the bottom of page in realtime as the user is ticking
	// filter options in the left panel. 
	// The way this works is that, initially, the body is filled with all products
	// in the database, albeit numbered paginations. Then this sidebar.php tries to 
	// hide all those that doesn't match the description ticked by the user. If no 
	// tick made, it shows all.
	// From what I can see at the moment, the author tries to communicate with the database 
	// with each tick. At the moment, it can change the pagination
	// count at bottom, and it can also return only those products that matches the users' selection
	// but the first page doesn't change in real-time until you click the pagination links.
	// a lot of work to be done here when I have indexed all the website contents
	$aMan  = array();
	$aPCat = array();
	$aCat  = array();

	// What is stored in $_REQUEST['man'] array?
	// This part is extracting those values but I'm yet to know
	// what is stored inside $_REQUEST['man'] and where the data
	// came from
...
//////
	...
	// What is stored in $_REQUEST['p_cat'] array?
	// This part is extracting those values but I'm yet to know
	// what is stored inside $_REQUEST['p_cat'] and where the data
	// came from
...
////
	...
	// What is stored in $_REQUEST['cat'] array?
	// This part is extracting those values but I'm yet to know
	// what is stored inside $_REQUEST['cat'] and where the data
	// came from
...
<!-- ________________________________________________________________________________ -->
	<!-- we are yet to touch anything below this line until we've indexed all the website contents -->
...
$run_manfacturer = mysqli_query($database, $get_manfacturer);
